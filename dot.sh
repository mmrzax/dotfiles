cp -r ~/.config/alacritty ~/Documents/dotfiles
cp -r ~/.config/htop ~/Documents/dotfiles
cp -r ~/.config/gotop ~/Documents/dotfiles
cp -r ~/.config/i3 ~/Documents/dotfiles
cp -r ~/.config/i3status ~/Documents/dotfiles
